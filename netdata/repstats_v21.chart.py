...
# where it will appear on the main stat page and menu (60000 will place it last)
priority = 1000
# retries = 60
...
class Service(UrlService):
    def __init__(self, configuration=None, name=None):
        ...
        self.url = self.configuration.get(
            'url', 'http://0.0.0.0:80/json/stats.json')
        self.order = ORDER
    ...
    def _get_data(self):
        ...
        apiKeys = [('saved_blocks_max', 'blockCountMax', int, 1),
                   ('saved_blocks_median', 'blockCountMedian', int, 1),
                   ('confirmed_max', 'cementedMax', int, 1),
                   ('confirmed_median', 'cementedMedian', int, 1),
                   ('unchecked_max', 'uncheckedMax', int, 1),
                   ('unchecked_median', 'uncheckedMedian', int, 1),
                   ('unchecked_min', 'uncheckedMin', int, 1),
                   ('peers_max', 'peersMax', int, 1),
                   ('peers_median', 'peersMedian', int, 1),
                   ('peers_min', 'peersMin', int, 1),
                   ('average_median', 'confAveMedian', int, 1),
                   ('average_min', 'confAveMin', int, 1),
                   ('perc_50', 'conf50Median', int, 1),
                   ('perc_75', 'conf75Median', int, 1),
                   ('perc_90', 'conf90Median', int,
                    1), ('perc_99', 'conf99Median', int, 1),
                   ('diff_median', 'diffMedian', int, 1),
                   ('diff_max', 'diffMax', int, 1),
                   ('multi_max', 'multiplierMax', float, 1000),
                   ('multi_median', 'multiplierMedian', float, 1000),
                   ('multi_min', 'multiplierMin', float, 1000),
                   ('api_max', 'procTimeMax', int, 1),
                   ('api_median', 'procTimeMedian', int, 1),
                   ('api_min', 'procTimeMin', int, 1),
                   ('supported_blocks', 'lenBlockCount', int, 1),
                   ('supported_cemented', 'lenCemented', int, 1),
                   ('supported_peers', 'lenPeers', int, 1),
                   ('supported_conf', 'lenConf50', int, 1),
                   ('supported_proc', 'lenProcTime', int, 1),
                   ('supported_multiplier', 'lenMultiplier', int, 1),
                   ...
                   ('bps_max_10', 'BPSMax', float, 1000),
                   ('bps_median_10', 'BPSMedian', float, 1000),
                   ('bps_p75', 'BPSp75', float, 1000),
                   ('cps_max_10', 'CPSMax', float, 1000),
                   ('cps_median_10', 'CPSMedian', float, 1000),
                   ('cps_p75', 'CPSp75', float, 1000),
                   ('bw_p10', 'bwLimit10', int, 1),
                   ('bw_p25', 'bwLimit25', int, 1),
                   ('bw_p50', 'bwLimit50', int, 1),
                   ('bw_p75', 'bwLimit75', int, 1),
                   ('bw_p90', 'bwLimit90', int, 1)]
        ...
        for new_key, orig_key, keytype, mul in apiKeys:
            try:
                # for example multiply by 1000 here
