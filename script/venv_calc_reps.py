...
if XXX:
    ...
    nodeUrl = 'http://127.0.0.1:45000'
    telemetryAddress = '127.0.0.1'
    telemetryPort = '17075'
    websocketAddress  = 'ws://0.0.0.0:47000'
    logFile="repstat.log"
    statFile = 'stats.json' #placed in a web server for public access
    monitorFile = 'monitors.json' #placed in a web server for public access
    activeCurrency = 'nano' #nano, banano or nano-beta
...
async def getPeers():
    ...
    while 1:
        ...
        try:
            if ninjaMonitors == "":
                monitors = [{"monitor":{"sync":0,"url":"http://localhost:46000","version":"0","blocks":0},"account":""}]
            else:
